...
{
    [System.Serializable]
    public unsafe partial class MissileSubTemplate : ExplodingSubTemplate
    {
        public FP Speed;
        public FP LerpTime;

        public override void OnUpdate(Frame f, EntityRef user, EntityRef target, EntityRef subWeapon, SubInstance* subWeaponInstance)
        {
