...
namespace Quantum.Demo
{
    public class UIConnect : UIScreen<UIConnect>
    {
        ...
        {
            if (string.IsNullOrEmpty((ProfileController.Instance as ProfileController).Profile.Username.Trim()))
            {
            ...
            if (UIMain.Client.ConnectUsingSettings(appSettings, (ProfileController.Instance as ProfileController).Profile.Username))
            {
                HideScreen();
