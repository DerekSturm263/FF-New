...
using Type = SerializableWrapper<Picture>;

public class DisplayPicture : Display<Type, Extensions.Types.Tuple<UnityEvent<string>[], UnityEvent<Sprite>>>
{
    ...
    protected override Type GetValue() => PictureController.Instance.CurrentSelected;
}
