  ...
  public class StaticEdgeCollider2DEditor : UnityEditor.Editor {
    ...
    private void DrawMovementHandles(QuantumStaticEdgeCollider2D collider) {
      ...
      { // vertex A
        ...
        var fmh_3101_85_638457800974035217 = Quaternion.identity; var newPosition = Handles.FreeMoveHandle(collider.VertexA.ToUnityVector3(), handleSize, Vector3.zero, Handles.DotHandleCap);
      ...
      { // vertex B
        ...
        var fmh_3114_85_638457800974047197 = Quaternion.identity; var newPosition = Handles.FreeMoveHandle(collider.VertexB.ToUnityVector3(), handleSize, Vector3.zero, Handles.DotHandleCap);
  ...
  public class StaticPolygonCollider2DEditor : UnityEditor.Editor {
    ...
    private void DrawMovementHandles(QuantumStaticPolygonCollider2D collider) {
      ...
      for (int i = 0; i < collider.Vertices.Length; i++) {
        ...
        var fmh_3232_89_638457800974053918 = Quaternion.identity; var newPosition = Handles.FreeMoveHandle(collider.Vertices[i].ToUnityVector3(), handleSize, Vector3.zero, Handles.DotHandleCap);
